...
$execute positioned $(x) 100 $(z) if loaded ~ ~ ~ positioned over world_surface run summon falling_block ~ ~100 ~ {BlockState:{Name:"minecraft:barrel"},TileEntityData:{LootTable:"minecraft:archaeology/desert_pyramid",lock:{items:"bedrock",count:1}},Time:1,Tags:["mca.airdrop"]}
$execute positioned $(x) 100 $(z) if loaded ~ ~ ~ run tellraw @a ["",{"color":"gray","shadow_color":0,"text":"The Airdrop has laneded at:"},{"shadow_color":0,"text":" "},{"color":"red","shadow_color":0,"text":"x"},{"color":"dark_red","shadow_color":0,"score":{"name":"x","objective":"mca.airdrop_properties"}},{"color":"dark_gray","shadow_color":0,"text":" "},{"color":"red","shadow_color":0,"text":"z"},{"color":"dark_red","shadow_color":0,"score":{"name":"z","objective":"mca.airdrop_properties"}}]
